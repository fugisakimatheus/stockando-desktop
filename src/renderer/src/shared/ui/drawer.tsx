    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            // Base.
            'group/drawer-popup pointer-events-auto fixed z-50 m-(--drawer-inset,0px) flex h-(--drawer-content-height) max-h-(--drawer-content-max-height,none) min-h-0 w-(--drawer-content-width,auto) transform-[translate3d(var(--translate-x,0px),var(--translate-y,0px),0)_scale(var(--stack-scale))] flex-col border border-border/70 bg-popover/95 text-sm text-popover-foreground shadow-[0_20px_60px_rgba(15,23,42,0.16)] backdrop-blur-xl transition-[transform,height,opacity,filter] duration-450 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform outline-none select-none [interpolate-size:allow-keywords] data-[swipe-direction=down]:rounded-t-2xl data-[swipe-direction=down]:border-t data-[swipe-direction=left]:rounded-r-2xl data-[swipe-direction=left]:border-r data-[swipe-direction=right]:rounded-l-2xl data-[swipe-direction=right]:border-l data-[swipe-direction=up]:rounded-b-2xl data-[swipe-direction=up]:border-b dark:border-white/10 dark:bg-popover/90 dark:shadow-[0_20px_60px_rgba(2,6,23,0.3)]',
            // Nested.
