  ...
  return (
    <TabPrimitive
      ...
      className={cn(
        ...
        'data-selected:bg-background/90 data-selected:text-foreground dark:data-selected:border-white/10 dark:data-selected:bg-background/70 dark:data-selected:text-foreground',
